...
// init and destroy
s64  queue_init(struct s_queue *l, s64 blkmax);
s64  queue_destroy(struct s_queue *l);

// information functions
s64  queue_count(struct s_queue *l);
...
s64  queue_destroy_first_item(struct s_queue *q);

// end of queue functions
s64  queue_set_end_of_queue(cqueue *q, bool state);
bool queue_get_end_of_queue(struct s_queue *q);
